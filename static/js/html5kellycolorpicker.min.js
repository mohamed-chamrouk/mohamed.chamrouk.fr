...
var b=g.getAlphaFig();b&&(a-=b.width+b.padding);b=window.getComputedStyle(p.tag);b=parseInt(b.paddingBottom)+parseInt(b.paddingTop);0>=b&&(b=0);var c=r.getBoundingClientRect(),d=c.left+(window.scrollX||window.pageXOffset||document.body.scrollLeft);p.tag.style.top=145+"px";p.tag.style.left=d+"px";p.tag.style.display="block";KellyColorPicker.activePopUp=g;return!1}};this.setHueByDot=function(a){a=ia(a,h.pos)+h.startAngle;0>
